...
$.support.animation.end=events.animation.end[$.support.animation];}if(tests.csstransforms()){$.support.transform=new String(prefixed('transform'));$.support.transform3d=tests.csstransforms3d();}})(window.Zepto||window.jQuery,window,document);function foo(){$(".mobile__logo").find(".title").toggleClass("color"),$(".hamburger-slim").add(".mobile__logo").toggleClass("fixed");$("body").toggleClass("overflow"),$("#menu").fadeToggle()}$(function(){}),$(".main-slider").owlCarousel({items:1,loop:!0,margin:10,dots:!0}),$(".blog__slider").owlCarousel({items:3,loop:!0,margin:10,nav:!0,navText:["<i class='ti-angle-left'>","<i class='ti-angle-right'></i>"],responsive:{0:{items:1},480:{items:2},768:{items:3}}}),$(".clients-slider").owlCarousel({items:5,loop:!0,margin:5,responsive:{0:{items:1},480:{items:2},768:{items:6}}}),$(".paralax").parallax({imageSrc:"img/paralax_section.jpg"}),$(".hamburger-slim").on("click",foo),$("#menu").on("click",function(){screen.width<768&&foo()}),$(document).scroll(function(){$(this).scrollTop()>100?$(".toTop").show():$(".toTop").hide()});